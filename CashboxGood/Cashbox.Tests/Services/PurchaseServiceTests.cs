...
namespace Cashbox.Tests.Services
{
    ...
    public class PurchaseServiceTests
    {
        ...
        public void TestSetup()
        {
            ...
            var account2 = new Account { Id = 2, Name = "Account2", Balance = 500.17m };
            var account3 = new Account { Id = 3, Name = "Account3", Balance = 1000m };

            var order1 = new Order { Id = 1, AccountId = 1, Account = account1, Date = DateTime.Now, Total = PurchaseService.ORDERS_HISTORY_DISCOUNT_THRESHOLD - 10 };
            ...
            var order4 = new Order { Id = 4, AccountId = 3, Account = account3, Date = DateTime.Now, Total = PurchaseService.ORDERS_HISTORY_DISCOUNT_THRESHOLD + 10 };
            ...
            _fakeAccountRepository.Data.AddRange(new[] { account1, account2, account3 });
        ...
        [Test]
        public void Purchase_Should_correctly_update_balance_When_purchase_is_made()
        {
            // Arrange
            var product1 = new Product { Id = 1, Price = 1, Amount = 5 };
            var product2 = new Product { Id = 2, Price = 1, Amount = 10 };
            ...
            // Assert
            Assert.That(account.Balance, Is.EqualTo(3));
        }
